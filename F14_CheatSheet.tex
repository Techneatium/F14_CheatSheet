...
\input{./format/checklistformat_20211025}
	...
	\pagestyle{plain}
		...
		\begin{center}
			\begin{longtable}{l p{3cm} | p{8cm}}
				...
				\end{minipage} \\
				\midrule
				3. & \blue{Kneeboard} & \textsc{Retrieve} Coordinates, Elevation, Magnetic Variation from GROUND SETTINGS Page \\
				\midrule
...
%						\begin{enumerate}[label=(\alph*), resume]
		...
		\begin{center}
			\begin{longtable}{l p{3cm} | p{8cm}}
				...
				\end{minipage} \\
				\midrule
				\textbullet & \dblue{ZEROIZE Switch} & 
				\begin{minipage}[t]{\linewidth}
					\vspace{-7pt}
					\begin{itemize}
...
%				\midrule
		...
		\begin{center}
			\begin{longtable}{l p{3cm} | p{8cm}}
				...
				\midrule
				\textbullet & \dblue{Designate QDES} & \textbf{Trigger Full-Action} \\
				\bottomrule
			\end{longtable}
		\end{center}
