\documentclass[10pt,usenames,dvipsnames,twoside]{report}
%-----------------------------------------------------------------
% FORMATTING
%-----------------------------------------------------------------
% all formatting and packages are in this file
\input{./format/checklistformat_f14}
...
\begin{document}
	...
	\begin{center}
		\begin{longtable}{l p{3cm} | p{8cm}}
			...
			\midrule
			4. & \cbstart\dblue{RIO} & \emph{``Ready to Start''} \\
			\midrule
			...
			\end{minipage} \\
			\midrule
			7. & \cbstart\blue{Left Engine \break Start-Up} &
			\begin{minipage}[t]{\linewidth}
				\vspace{-7pt}
				\begin{enumerate}
			...
			\midrule
			11. & \cbstart\blue{AIR SOURCE} & \textbf{BOTH ENG} \\
			\midrule
	...
	\begin{center}
		\begin{longtable}{l p{3cm} | p{8cm}}
			...
			\midrule
			2. & \cbstart\blue{Displays Control Panel} &
			\begin{minipage}[t]{\linewidth}
				\vspace{-7pt}
				\begin{itemize}
			...
			\midrule
			7. & \cbstart\blue{Emergency Wing Sweep} &
			\begin{minipage}[t]{\linewidth}
				\vspace{-7pt}
				\begin{enumerate}
			...
			\midrule
			16. & \cbstart\dblue{RIO} & set D/L frequency \cbend\\
			\midrule
	...
	\begin{center}
		\begin{longtable}{l p{3cm} | p{8cm}}
			\toprule
			1. & \cbstart\blue{Oxygen} & \textbf{ON (FWD)} \thumbnar \\
			\midrule
			2. & \dblue{PILOT} &
			\begin{minipage}[t]{\linewidth}
				\vspace{-7pt}
			...
			\midrule
			6. & \cbstart\blue{Ejection Seats} & \textbf{ARMED} \\
			\midrule
	...
	\begin{center}
		\begin{longtable}{l p{3cm} | p{8cm}}
			...
			\midrule
			4. & \cbstart\blue{Start INS Align} &
			\begin{minipage}[t]{\linewidth}
				\vspace{-7pt}
				\begin{enumerate}
			...
			\midrule
			20. & \cbstart\blue{IR/TV Power} & \textbf{ON} \\
			\midrule
	...
	\begin{center}
		\begin{longtable}{l p{3cm} | p{8cm}}
			...
			\midrule
			16. & \cbstart\blue{Complete INS Align} &
			\begin{minipage}[t]{\linewidth}
				\vspace{-7pt}
				\begin{itemize}
