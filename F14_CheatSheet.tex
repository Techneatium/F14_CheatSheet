...
%		\subsection{ACM MODES - MRL}
		...
		\begin{center}
			\begin{longtable}{l p{3cm} | p{8cm}}
				\toprule
				\textbullet & \dblue{Startup} & 
				\begin{minipage}[t]{\linewidth}
					\vspace{-7pt}
					\begin{enumerate}[label=(\alph*)]
						\item \textbf{Power Switch} \dotfill \textbf{POD}
					\end{enumerate} 
					\vspace{7pt}
					8 min startup sequence, \textbf{MODE Switch} shows \textbf{STBY} when complete
					\begin{enumerate}[label=(\alph*), resume]
						\item \textbf{Mode Switch} \dotfill \textbf{Press}
					\end{enumerate} 
					30 sec initialization, \textbf{MODE Switch} shows \textbf{OPER} when ready
					\begin{enumerate}[label=(\alph*), resume]
		...
		\begin{center}
			\begin{longtable}{l p{3cm} | p{8cm}}
				...
				\end{minipage} \\
				\midrule
				\textbullet & \dblue{Indicator Lights} &
				\begin{minipage}[t]{\linewidth}
					\vspace{-7pt}
					\begin{itemize}
