			...
			\begin{tabular}{l p{3cm} | p{8cm}}
				...
				\begin{minipage}[t]{\linewidth}
					...
					\begin{itemize}
						...
						\item Gunsight Lead \dotfill as required
					\end{itemize} 
				\end{minipage} \\
				\midrule
				2. & \blue{Employment} & 
			...
			\begin{tabular}{l p{3cm} | p{8cm}}
				...
				\begin{minipage}[t]{\linewidth}
					...
					\begin{itemize}
						...
						\item \textbf{HUD} \dotfill \textbf{A/A}
						\item \textbf{Gun Rate} \dotfill \textbf{HIGH}
						\item \textbf{Radar} \dotfill \textbf{STT lock}
						\begin{itemize}
							\item RIO STT lock
							\item ACM Modes
						\end{itemize}
			...
			\begin{tabular}{l p{3cm} | p{8cm}}
				...
				\begin{minipage}[t]{\linewidth}
					...
					\begin{itemize}
						...
						\item \textbf{HUD} \dotfill \textbf{A/A}
						\item \textbf{SW COOL} \dotfill \textbf{ON}
						\item \textbf{Radar} \dotfill STT lock
						\begin{itemize}
							\item RIO STT lock
							\item ACM Modes
						\end{itemize}
		...
		\begin{center}
			\begin{tabular}{l p{3cm} | p{8cm}}
				...
				\begin{minipage}[t]{\linewidth}
					\vspace{-7pt}
					\begin{enumerate}[label=(\alph*)]
						\item \textbf{WEAPON SELECTOR} \dotfill \textbf{SP/PH}
						\item \textbf{MODE/STP} \dotfill \textbf{NORM}
					\end{enumerate}
					\begin{itemize}
						\item \textbf{NORM}
