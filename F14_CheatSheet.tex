...
%		\subsection{ACM MODES - MRL}
		...
		\begin{center}
			\begin{tabular}{l p{3cm} | p{8cm}}
				\toprule
				\textbullet & \blue{Missile Preparation} & 
				\begin{minipage}[t]{\linewidth}
					\vspace{-7pt}
					\begin{itemize}
		...
		\begin{center}
			\begin{tabular}{l p{3cm} | p{8cm}}
				...
				\end{minipage} \\
				\midrule
				3. & \dblue{MSL OPTIONS} & \textbf{As Desired}
			...
			\begin{tabular}{l p{3cm} | p{8cm}}
				...
				\begin{minipage}[t]{\linewidth}
					...
					\begin{enumerate}[label=(\alph*)]
						...
						\begin{itemize}
							\item \textbf{TID} TTI appears
							\item \textbf{WCS MODE} switches to \textbf{TWS AUTO}
							\item \textbf{Priority} automatically collapses by one
							\item \textbf{Repeat} for remaining targets
						\end{itemize}
