...
\newtcolorbox{mandatory}[1]{
	enhanced,
	colback=white,
	colframe=color1,
	colbacktitle=color1,
	breakable,
	left=0pt, bottom=0pt, right=0pt, top=0pt,
	% lefttitle=1mm, bottomtitle=1mm, righttitle=1mm, toptitle=1mm,
	lefttitle=1mm, bottomtitle=-0.25mm, righttitle=0mm, toptitle=-0.75mm,
	boxsep=0pt,
	title=\textbf{#1},
...
\begin{document}
	...
	\begin{center}
		\begin{longtable}{l p{3cm} | p{8cm}}
			\toprule
			1. & \blue{Parking Brake} & \textbf{ENGAGED} \\
			\midrule
	...
	\begin{center}
		\begin{longtable}{l p{3cm} | p{8cm}}
			...
			\end{minipage} \\
			\midrule
			7. & \blue{Left Engine \break Start-Up} &
			\begin{minipage}[t]{\linewidth}
				\vspace{-7pt}
				\begin{enumerate}
	...
	\begin{center}
		\begin{longtable}{l p{3cm} | p{8cm}}
			...
			\midrule
			12. & \blue{ARA-63 ICLS \break RECEIVER} & \textbf{ON} \\
			\midrule
