...
%				\midrule
		...
		\begin{center}
			\begin{longtable}{l p{3cm} | p{8cm}}
				\toprule
				\textbullet & \blue{A/G Designation} & \textbf{Trigger Second Detent}
				\begin{minipage}[t]{\linewidth}
					\vspace{-7pt}
					\begin{enumerate}[label=(\alph*)]
		...
		\begin{center}
			\begin{longtable}{l p{3cm} | p{8cm}}
				...
				\midrule
				\textbullet & \dblue{Designate QDES} & \textbf{Trigger Full-Action} \thumbnar\\
				\bottomrule
			\end{longtable}
		\end{center}
		...
		\begin{center}
			\begin{longtable}{l p{3cm} | p{8cm}}
				...
				\end{minipage} \\
				\midrule
				\textbullet & \blue{Top Center} \thumbnar &
				\begin{minipage}[t]{\linewidth}
					\vspace{-7pt}
					\begin{itemize}
		...
		\begin{center}
			\begin{longtable}{l p{3cm} | p{8cm}}
				...
				\end{minipage} \\
				\midrule
				4. & \dblue{Slew LANTIRN} & \hyperlink{subsec:lantirncontrolsstick}{\textbf{Refer to LANTIRN Control Section}}
