...
\newfontfamily\tightSpartan{Spartan}[Ligatures=TeX, Scale=0.85, BoldFeatures={LetterSpace=0.0}] % used for `---` in page numbering
...
\fancypagestyle{plain}{
	...
	\fancyfoot[C]{{\tightSpartan \textbf{--- \thepage \ ---}}}% LE,RO
	% date in top right
...
\colorlet{color4}{NavyBlue} % NavyBlue
...
% default: 1.55em
% required for Spartan font: 3.1em for subsec 2.20
\setlength{\cftsecnumwidth}{1.55em}
\setlength{\cftsubsecnumwidth}{3.10em}
...
{\color{color1}\thesection}{1em}{#1}[{\titlerule[1pt]}]
